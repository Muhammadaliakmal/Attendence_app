...
import { Mail, Lock, UserPlus, Sparkles, Shield } from 'lucide-react';
        ...
        <div className="glass-card rounded-3xl p-8 shadow-premium">
          ...
          <div className="text-center mb-8">
            <motion.div
              ...
              className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white shadow-glow mx-auto mb-4"
            >
              <UserPlus size={32} />
            </motion.div>
          ...
          >
            ...
            <Form.Item className="!mb-4">
              <Button
                ...
                loading={loading}
                block
                className="!h-12 !text-base !font-semibold !mt-2 !bg-gradient-to-r !from-emerald-600 !to-teal-600 hover:!from-emerald-500 hover:!to-teal-500"
